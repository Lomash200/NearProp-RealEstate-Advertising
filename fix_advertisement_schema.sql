-- Add missing columns for advertisement clicks
ALTER TABLE advertisements ADD COLUMN IF NOT EXISTS click_count bigint DEFAULT 0;
ALTER TABLE advertisements ADD COLUMN IF NOT EXISTS view_count bigint DEFAULT 0;
ALTER TABLE advertisements ADD COLUMN IF NOT EXISTS whatsapp_clicks bigint DEFAULT 0;
ALTER TABLE advertisements ADD COLUMN IF NOT EXISTS phone_clicks bigint DEFAULT 0;
ALTER TABLE advertisements ADD COLUMN IF NOT EXISTS website_clicks bigint DEFAULT 0;
ALTER TABLE advertisements ADD COLUMN IF NOT EXISTS social_media_clicks bigint DEFAULT 0;
